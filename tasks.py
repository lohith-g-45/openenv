...
TASKS: List[Task] = [
    ...
    Task(
        ...
        test_cases=[
            ...
            {"name": "t5", "input": "two_sum([2, 7, 11, 15], 9)", "expected": "[0, 1]"},
        ],
        hidden_test_cases=[
            ...
            {"name": "h5", "input": "two_sum([2, 7, 11, 15], 9)", "expected": "[0, 1]"},
        ],
    ...
    Task(
        ...
        test_cases=[
            ...
            {"name": "t5", "input": "trap([1,0,2,1,0,1,3,2,1,2,1])", "expected": "6"},
        ],
        hidden_test_cases=[
            ...
            {"name": "h5", "input": "trap([1,0,2,1,0,1,3,2,1,2,1])", "expected": "6"},
        ],
